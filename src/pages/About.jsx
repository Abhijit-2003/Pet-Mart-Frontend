  ...
  const teamMembers = [
    {
      ...
      bio: "A passionate full-stack Java developer with hands-on experience in building responsive web applications using Spring Boot and React.js. He specializes in developing clean RESTful APIs, scalable backend systems with Java and MySQL, and dynamic user interfaces using React.js With a strong understanding of both frontend and backend technologies and also loves to learn new tools.I enjoys creating seamless, user-focused applications backed by robust architecture.",
      skills: [
        "Java",
        "Spring Boot",
        "REST APIs",
    ...
    },
    {
      ...
      role: "Full Stack Developer",
      bio: "A enthusiastic full-stack Java developer with solid hands-on experience in building responsive and user-centric web applications using Spring Boot and React.js. Excels at crafting clean and efficient RESTful APIs, designing scalable backend systems with Java and MySQL, and developing interactive frontend interfaces using React.Enthusiasm for learning new technologies, allows me to stay updated with industry trends and deliver modern, user-focused solutions.",
      skills: [
        "Spring Boot",
        "RESTful API",
        "Java",
